...
const ProfilePage = () => {
    ...
    return (
        <div className="w-full min-h-screen bg-gray-900 text-white p-6 relative">
            ...
            <h2 className="text-3xl text-center text-gray-200 mb-8">My Profile</h2>
            ...
            <div className="flex gap-6">
                ...
                <div className="w-1/2 bg-gray-800 p-4 rounded-lg">
                    ...
                    <div className="w-full px-4">
                        {myJobs.length === 0 ? (
                            <p className="text-gray-300 text-center">You haven't created any jobs yet.</p>
                        ) : (
